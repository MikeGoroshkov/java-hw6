 ...
 */
public class Base {
    Notebook note1 = new Notebook("HUAWEI", "MateBook D 14", "Intel Core i5 1155G7",
            6, 8, 512, "Intel Iris Xe Graphics", 4, "Windows 11 Home", "серебристый", 39000);
    Notebook note2 = new Notebook("Acer", "Nitro 5 AN515-45", "AMD Ryzen 5 5600H",
            4, 8, 512, "NVIDIA GeForce GTX 1650", 4, "DOS", "черный", 48000);
    Notebook note3 = new Notebook("ASUS", "X515EA-BQ1185W", "Intel Core i5 1135G7",
            4, 16, 1024, "Intel Iris Xe Graphics", 4, "Windows 11 Home", "черный", 45000);
    Notebook note4 = new Notebook("HP", "OMEN 16-b1017ci", "Intel Core i7-12700H",
            8, 16, 1024, "NVIDIA GeForce RTX 3070", 8, "Windows 11 Home", "серый", 65000);
    Notebook note5 = new Notebook("HONOR", "MagicBook 15", "AMD Ryzen 5 5500U",
            6, 8, 512, "AMD Radeon Graphics", 4, "без ОС", "серебристый", 57000);
